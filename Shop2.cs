...
namespace ConsoleApp2
{
    ...
    class Buyer : User
    {
        ...
        {
            return new List<Product>(_productBasket);
        }
        ...
        public void ShowProducBasket()
        {
            ...
            foreach (var p in _productBasket)
            {
                Console.WriteLine(p);
            }
        }
    ...
    class Shop
    {
        ...
        public void StartTrading()
        {
            ...
            while (isWork)
            {
                ...
                Console.Clear();
                Console.WriteLine($"Деньги покупателя: {_buyer.GetMoney()}");
                Console.WriteLine($"Деньги продовца: {_seller.GetMoney()}");
